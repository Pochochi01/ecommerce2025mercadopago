...
const ProductImageUpload = ({
    ...
    async function uploadImageToCloudinary() {
        ...
        const response = await axios.post('http://31.97.85.19:5000/api/admin/products/uploadImage', data)
    ...
    <div className={`w-full mt-2 ${isCustomStyling ? '': 'max-w-md mx-auto'}`}>
        ...
        <div 
            ...
            className={` ${isEditMode ? 'cursor-not-allowed' : ''} flex flex-col items-center justify-center h-14 cursor-pointer`} >
                ...
                <span>Has click para cargar la imagen</span>
            ...
            <div className='flex items-center justify-between'>
                ...
                <Button 
                    ...
                    <span className='sr-only'>Borrar Archivo</span>
                </Button>
            </div>
            )}
        </div>
