...
const ProductDetailsDialog = ({ open, setOpen, productDetails }) => {
  ...
  if(getCartItems.lenght){
    ...
    if(indexOfCurrentItems > -1){
      ...
      if(getQuantity + 1 > getTotalStock){
        toast({
          title:`Se pueden agregar ${getQuantity} maximo de este items`,
          variant: 'destructive'
        });
        return;
      }
  ...
  const averageReview = reviews && reviews.lenght > 0 ?
  reviews.reduce((sum, reviewItem)=> sum + reviewItem.reviewValue,0) / reviews.lenght : 0;
        ...
        <div className="">
          ...
          <div className="max-h-[300px] overflow-auto">
            ...
            <div className="mt-10 flex-col flex gap-2">
              <Label>Que opinas de este producto</Label>
