...
console.log('ApprovalURL',approvalURL)
  ...
  function handleInitiateMercadoPagoPayment(){
    ...
    if(cartItems.lenght === 0){
      toast({
        title: 'El carrito esta vacio, por favor agregue productos',
        variant: 'destructive',
      })
    }
    ...
    if(currentSelectedAddress === null) {
      toast({
        title: 'Por favor seleccione un domicilio para proceder',
        variant: 'destructive'
      })
      return;
    }
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 gap-5 mt-5 p-5'>
        ...
        <div className='mt-4 w-full'>
          <Button onClick={handleInitiateMercadoPagoPayment} className='w-full'>
            {
              isPaymentStart ? 'Compra Confirmada...' : 'Pagar con MercadoPago'
            }
          </Button>
        </div>
        </div>
